...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright CarloBeltrame, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/PluginTemplate-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PluginTemplate-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PluginTemplate-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PluginTemplate-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PluginTemplate-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PluginTemplate-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/PluginTemplate-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/PluginTemplate.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/PluginTemplate.iss",inplace=1):
